...
def run_all_baselines(n_samples: int = 50, output_dir: str = "results", model: str = "claude-haiku-4-5"):
    ...
    methods = [
        ...
        ("Always-Retrieve k=3", always_retrieve, {"question": None, "paragraphs": None, "k": 3, "model": model}),
        ("Always-Retrieve k=5", always_retrieve, {"question": None, "paragraphs": None, "k": 5, "model": model}),
    ]
...
def print_summary(results: list[dict], output_dir: Path, model: str):
