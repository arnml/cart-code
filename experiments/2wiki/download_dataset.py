"""Download and cache 2WikiMultiHopQA locally.

Usage:
    uv run python -m experiments.2wiki.download_dataset
    uv run python -m experiments.2wiki.download_dataset --split train
    uv run python -m experiments.2wiki.download_dataset --split all --force
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Download and cache 2WikiMultiHopQA.")
    parser.add_argument(
        "--split",
        default="all",
