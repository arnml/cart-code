...
Bandit algorithms (UCB, Thompson Sampling, and contextual bandit methods such as LinUCB) have been applied to retrieval, ranking, and exploration-exploitation problems broadly~\cite{auer2002ucb1,thompson1933,chu2011linucb}. We test whether UCB1-TUNED and a LinUCB-style contextual bandit can learn useful context-selection signals on HotpotQA distractor, finding they cannot due to structural properties of the benchmark. We characterize those failure modes in a concrete setting.
